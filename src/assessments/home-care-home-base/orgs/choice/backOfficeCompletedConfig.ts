		...
		subHeadings: [
				...
				subGroups: [
					...
					},
					{
						...
						questions: [
							...
							{ id: 'PA-b557f8', source: AssessmentQuestionSources.PhysicalAssessment }, //impaired body functions
							{
								id: 'PA-1386f9',
								source: AssessmentQuestionSources.PhysicalAssessment,
								artifactContext: ['ReferralDocument'],
							...
							{ id: 'PA-09c249', source: AssessmentQuestionSources.PhysicalAssessment }, //disciplines needed
						],
					},
					{
				...
				subGroups: [
					{
						...
						questions: [
							...
							//fill manual form fields here (for now)
						],
					},
					{
			...
			},
			{
				...
				subGroups: [
					...
					{
						heading: 'COVID-19 Screening',
						questions: [
							{ id: 'PA-a8b320', source: AssessmentQuestionSources.PhysicalAssessment }, //COVID-19 screening
							{ id: 'PA-1ba944', source: AssessmentQuestionSources.PhysicalAssessment },
							{ id: 'PA-364364', source: AssessmentQuestionSources.PhysicalAssessment },
							{ id: 'PA-deaf3c', source: AssessmentQuestionSources.PhysicalAssessment },
							{ id: 'PA-a35224', source: AssessmentQuestionSources.PhysicalAssessment },
							{ id: 'PA-21d993', source: AssessmentQuestionSources.PhysicalAssessment },
						],
					},
				],
			},
			...
			},
			{
				...
				subGroups: [
					...
					},
					{
						heading: 'Psychiatric',
						questions: [
							{ id: 'PA-cc8550', source: AssessmentQuestionSources.PhysicalAssessment }, // psych assessment
						],
					},
				],
			},
	...
	},
	{
		...
		subGroups: [
			...
			},
			{
				...
				questions: [
					{ id: 'PA-1fa7c7', source: AssessmentQuestionSources.PhysicalAssessment }, //homebound reason
					{ id: 'PA-b557f8', source: AssessmentQuestionSources.PhysicalAssessment }, //impaired body functions
					{ id: 'PA-c77203', source: AssessmentQuestionSources.PhysicalAssessment }, //limitations
					{ id: 'PA-d8c4ab', source: AssessmentQuestionSources.PhysicalAssessment }, //limitations
					{ id: 'PA-09c249', source: AssessmentQuestionSources.PhysicalAssessment }, //appropriate disciplines
					{ id: 'PA-1386f9', source: AssessmentQuestionSources.PhysicalAssessment }, //restricted from leaving home except...
					{ id: 'PA-a86932', source: AssessmentQuestionSources.PhysicalAssessment }, //normal inablity to leave home
				],
			},
			{
	...
	},
	{
		...
		subGroups: [
			...
			},
			{
				...
				questions: [
					{
						note: 'Do not edit mileage for this patient.',
					},
					//{ patientDataResolver: DataRendererOptions.MILEAGE},
				],
			},
